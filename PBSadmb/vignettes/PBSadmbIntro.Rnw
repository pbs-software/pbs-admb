...
The program offers users a remarkably efficient tool for estimating parameters and their uncertainty, based on complex nonlinear statistical models.
...
The \href{https://github.com/pbs-software/pbs-awatea}{GitHub} web site features the most recent revisions to \pbsa{}, including tagged versions of the package.
...
For futher information about the series, see \href{https://github.com/pbs-software/pbs-software}{PBS Software} on GitHub. 
